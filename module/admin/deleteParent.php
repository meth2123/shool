...
// Get parents created by this admin
...
<head>
    ...
    <title>Supprimer un Parent</title>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-semibold text-gray-800">
                    <i class="fas fa-user-minus mr-2 text-red-500"></i>
                    Supprimer un Parent
                </h2>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <form action="deleteParentTableData.php" method="post" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce parent ?');">
                                    <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']); ?>">
                                    <button type="submit" name="submit" class="text-red-600 hover:text-red-900">
